...
Create only approved missing contacts in Apollo and persist the created identifiers.
...
3. Persist declared output keys or artifacts exactly; expected evidence includes `existing_apollo_match`, `new_contact_id`.
