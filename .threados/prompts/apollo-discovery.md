...
Discover new Apollo prospects within the ICP, budget, geography, and persona constraints without premature enrichment.
...
3. Persist declared output keys or artifacts exactly; expected evidence includes `discovered_prospects`.
