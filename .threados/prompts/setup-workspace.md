...
Create workspace-local Apollo scratch directories and capture optional local notification configuration.
...
3. Persist declared output keys or artifacts exactly; expected evidence includes `telegram_chat_id`.
