...
Resolve the configured Apollo target stage to a concrete stage identifier before persistence mutations.
...
3. Persist declared output keys or artifacts exactly; expected evidence includes `resolved_stage_id`, `missing_stage_decision`.
