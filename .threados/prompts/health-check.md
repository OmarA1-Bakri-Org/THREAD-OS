...
Verify the configured Apollo, state-management, and local runtime dependencies are usable before the workflow proceeds.
...
3. Persist declared output keys or artifacts exactly; expected evidence includes `health`.
