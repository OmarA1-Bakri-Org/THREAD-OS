...
Merge discovery sources, deduplicate contacts, apply compliance/pipeline exclusions, assign personas, and persist the qualified segment.

## Inputs

- Dependency steps: `apollo-saved-contacts-search`, `apollo-discovery`.
...
3. Persist declared output keys or artifacts exactly; expected evidence includes `qualified_segment`.
